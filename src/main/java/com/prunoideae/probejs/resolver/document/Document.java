...
import com.prunoideae.probejs.resolver.document.part.*;
...
public class Document implements IStateHandler<String> {
    ...
    public static String formatType(String s) {
        ...
        List<String> param = Util.unwrapString(s, "<", ">");
