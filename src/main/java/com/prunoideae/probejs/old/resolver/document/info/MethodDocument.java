...
public class MethodDocument {
    ...
    public MethodDocument(String methodComponent) {
        ...
        List<String> nameParamReturn = StringUtil.unwrapString(methodComponent, "(", ")");
        ...
        this.params = StringUtil.splitString(nameParamReturn.get(1), ",", "<", ">");
    ...
    public boolean compareType(String str, Type type) {
        ...
        if (type instanceof ParameterizedType) {
            List<String> unwrapped = StringUtil.unwrapString(str, "<", ">");
            if (unwrapped.size() != 3)
                return false;
